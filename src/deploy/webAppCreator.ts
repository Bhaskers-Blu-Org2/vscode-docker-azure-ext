...
import { AzureImageNode } from '../azureRegistryExplorer';
...
export class WebAppCreator extends WizardBase {
    ...
    constructor(output: vscode.OutputChannel, readonly azureAccount: AzureAccountWrapper, context: AzureImageNode | any, subscription?: SubscriptionModels.Subscription) {
        super(output);
...
class WebsiteStep extends WebAppCreatorStepBase {
    ...
    constructor(wizard: WizardBase, azureAccount: AzureAccountWrapper, context: AzureImageNode | any) {
